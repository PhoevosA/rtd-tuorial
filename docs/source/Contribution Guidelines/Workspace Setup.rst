...
1. Detailed steps for configuring SPLICE workspace can be found in the :doc:`link <../extra/Configure Workspace.rst>`.
...
You can find more details on our PR guidelines :doc:`here <../Contribution Guidelines/Pull Request (PR) Guidelines.rst>`
